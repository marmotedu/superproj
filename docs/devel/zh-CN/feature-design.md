...
superproj设计目的是能够在一个项目中，有机整合 Go 项目开发中用到的几乎所有的核心功能点，以及大部分常用功能点。本篇文章会详细罗列这些功能点，以及设计方式。
...
- Kubernetes编程开发实战：
  - 声明式 API 编程范式（Kubernetes 编程）：
    ...
    - Kubernetes controller：superproj-minerset-controller, superproj-miner-controller, superproj-controller-manager；
