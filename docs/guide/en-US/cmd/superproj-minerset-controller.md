...
state of the minerset through the superproj-apiserver and makes changes attempting to move the
current state towards the desired state.

```
superproj-minerset-controller [flags]
```
...
```
  ...
  -h, --help                                 help for superproj-minerset-controller
