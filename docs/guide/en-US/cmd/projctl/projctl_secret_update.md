...
```
projctl secret update SECRET_NAME
```
...
```
  # Update a secret resource
  projctl secret update foo --expires=4h --description="new description"
```
...
```
      ...
      --expires int          The expires of the secret.
