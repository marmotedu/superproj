...
* [projctl jwt show](projctl_jwt_show.md)	 - Show header and claims for a JWT token
* [projctl jwt sign](projctl_jwt_sign.md)	 - Sign a jwt token with given secretID and secretKey
* [projctl jwt verify](projctl_jwt_verify.md)	 - Verify a JWT token
