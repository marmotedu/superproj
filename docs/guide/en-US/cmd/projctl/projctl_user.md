...
* [projctl user create](projctl_user_create.md)	 - Create a user resource
* [projctl user delete](projctl_user_delete.md)	 - Delete a user resource from iam platform (Administrator rights required)
* [projctl user get](projctl_user_get.md)	 - Display a user resource.
* [projctl user list](projctl_user_list.md)	 - Display all users in iam platform (Administrator rights required)
* [projctl user update](projctl_user_update.md)	 - Update a user resource
