...
```
projctl user create USERNAME PASSWORD EMAIL
```
...
```
  ...
  projctl user create foo Foo@2020 foo@foxmail.com
  
  # Create user wt
  projctl user create foo Foo@2020 foo@foxmail.com --phone=18128845xxx --nickname=colin
```
