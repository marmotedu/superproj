...
Delete a user resource from iam platform (Administrator rights required)

### Synopsis

Delete a user resource from iam platform, only administrator can do this operation.

```
projctl user delete USERNAME
```
