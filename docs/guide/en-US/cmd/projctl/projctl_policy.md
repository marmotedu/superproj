...
* [projctl policy create](projctl_policy_create.md)	 - Create a authorization policy resource
* [projctl policy delete](projctl_policy_delete.md)	 - Delete a authorization policy resource
* [projctl policy get](projctl_policy_get.md)	 - Display a authorization policy resource
* [projctl policy list](projctl_policy_list.md)	 - Display all authorization policy resources
* [projctl policy update](projctl_policy_update.md)	 - Update a authorization policy resource
